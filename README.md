...
$$\mathbf u\vert_{\Gamma_\text{outlet}}\overline\otimes\mathbf n=\frac{\mathbf u\vert_{\Gamma_\text{outlet}}\overline\otimes\mathbf n-\vert\mathbf u\vert_{\Gamma_\text{outlet}}\overline\otimes\mathbf n\vert}{2}=\left\lbrace\begin{array}{ll}\mathbf u\vert_{\Gamma_\text{outlet}}\overline\otimes\mathbf n&\text{if }\mathbf u\vert_{\Gamma_\text{outlet}}\overline\otimes\mathbf n>0\\0&\text{else}\end{array}\right.$$
